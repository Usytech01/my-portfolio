        ...
        >
          ...
          <div>
            <motion.div variants={itemVariants}>
              ...
              {/* Stats Grid */}
              <div className="grid grid-cols-3 gap-8 p-8 rounded-3xl bg-white/50 dark:bg-slate-900/50 backdrop-blur-md border border-slate-200 dark:border-white/5 shadow-sm dark:shadow-none">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center">
                    <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">{stat.value}</p>
                    <p className="text-[10px] text-slate-600 dark:text-gray-400 uppercase tracking-widest font-bold">{stat.label}</p>
                  </div>
                ))}
              </div>
          ...
          <div className="space-y-6">
            <motion.div 
              ...
              className="bg-white/90 dark:bg-[#0f172a]/80 backdrop-blur-xl p-8 rounded-[2rem] relative group border border-slate-200 dark:border-white/10 hover:border-blue-500/30 transition-all duration-500"
            >
              ...
              <p className="text-slate-700 dark:text-slate-300 mb-6">Research-backed UI/UX, wireframing, and interactive prototyping.</p>
              
              <ul className="space-y-3">
                {['User Research', 'Visual Identity', 'Prototyping'].map((skill) => (
                  <li key={skill} className="flex items-center gap-3 text-sm text-slate-600 dark:text-gray-300">
            ...
            <motion.div 
              variants={itemVariants}
              className="bg-white/90 dark:bg-[#0f172a]/80 backdrop-blur-xl p-8 rounded-[2rem] relative group border border-slate-200 dark:border-white/10 hover:border-purple-500/30 transition-all duration-500"
            >
              <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
              ...
              <p className="text-slate-700 dark:text-slate-300 mb-6">Full-stack architecture using React, Next.js, and specialized styling with Tailwind CSS.</p>
